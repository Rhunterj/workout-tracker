...
export function ExerciseSelectionViewWorkout({
  workoutId,
}: ExerciseSelectionViewWorkoutProps) {
  ...
  const handleSelectExercise = (exercise: {
    ...
    router.push(
      `/workout/${workoutId}/add-exercise/${
        newExercise.id
      }?name=${encodeURIComponent(exercise.name)}&new=true`
    );
  };
  ...
  const handleCreateCustom = () => {
    ...
    router.push(
      `/workout/${workoutId}/add-exercise/${
        newExercise.id
      }?name=${encodeURIComponent(newExercise.name)}&new=true`
    );
  };
